...
const handleStyle = theme => {
  const colors = {
    primary: 'rgb(98, 179, 98)',
    thumbOutline: fade('rgb(98, 179, 98)', 0.16),
  }
  ...
  return (
    <Fragment>
      ...
      <div
        ...
        style={{ left: `${percent}%` }}
      >
      <div style={{color: 'rgb(255, 255, 255)', fontFamily: 'Roboto', fontSize: 12, textAlign: 'center', marginTop: -20, marginLeft:-1 }}>
        {value}
      </div>
      </div>
    </Fragment>
